...
const facilityCards: FacilityCard[] = [
  ...
  { name: 'ICT Room', caption: 'Modern computers and digital tools building 21st-century tech skills.', img: '/images/ICT-ROOM.jpg.jpeg', alt: 'Sultan Hanafi ICT Room with laptops on every desk and smart TV' },
  { name: 'Chemistry Laboratory', caption: 'A safe, well-equipped space for practical chemistry experiments.', img: '/images/CHEMISTRY-LAB.jpg.jpeg', alt: 'Sultan Hanafi Chemistry Laboratory with periodic table and equipment' },
